<?php
/**
 * Este arquivo terá funções que lidam com o registro do usuário,
 * Entrar e esquecer a senha
 * @author Andersu Silva
 * @copyright www.developforweb.com.br
 */
class Cl_User
{
	/**
	 * @var vai conter conexão com o banco de dados
	 */
	protected $_con;
	
	/**
	 * ele inicializará a classe DB
	 */
	...
	/**
	 * isso irá manipular o processo de registro do usuário
	 * @param array $data
	 * @return boolean true or false baseado no retorno
	 */
	...
	/**
	 * Esse método manipulará o processo de login do usuário
	 * @param array $data
	 * @return boolean true or false baseado no retorno
	 */
	...
	/**
	 * Isso mostrará as informações da conta e manipulará a alteração da senha
	 * @param array $data
	 * @throws Exception
	 * @return boolean
	 */
	...
	/**
	 * Este processo de saída do identificador
	 */
	...
	/**
	 * Isso irá redefinir a senha atual e enviar nova senha para o email
	 * @param array $data
	 * @throws Exception
	 * @return boolean
	 */
	public function forgetPassword( array $data )
	{
		if( !empty( $data ) ){
			...
			if(mysqli_query($this->_con, $query)){
				mysqli_close($this->_con);
				$to = $email;
				$subject = "Nova Solicitação de Senha";
				$txt = "Sua nova senha ".$password;
				$headers = "From: admin@developforweb.com.br" . "\r\n" .
						"CC: demo@developforweb.com.br";
	...
	/**
	 * Isso irá gerar senha aleatória
	 * @return string
	 */
