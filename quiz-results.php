...
<div class="content">
	<div class="container">
    	...
    	<div class="row">
    		<h1 class="text_underline">Resultados do Quiz: </h1>
			<br/>
...
<script src='js/grid.locale-pt-br.js'></script>
<script src='js/jquery.jqGrid.min.js'></script>
<script>
	   jQuery("#list2").jqGrid({ 
	   url:'server.php', 
	   datatype: "json",
	   colNames:['Quiz Nº','Categoria', 'Resposta Correta', 'Resposta Incorreta','Não Respondida'],
