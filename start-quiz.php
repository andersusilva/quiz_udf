			...
			<?php require_once 'templates/ads.php';?>
     		<div class="row">
	     		...
	     		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 start-page">
	     			<h1 class="text_underline">Escolha sua Categoria: </h1>
					<form class="form-signin well" method="post" id='signin' name="signin" action="questions.php">
						...
						<div class="form-group">
							<select class="form-control" name="num_questions" id="num_questions">
								<option value="">Escolha a qtd. de perguntas exibidas por páginas.</option>
						...
						<br>
						<button id="start_btn" class="btn btn-success btn-block" type="submit">Iniciar!!!</button>
					</form>
				</div>
